...
import static com.powple.poc.intoxication.DrunkLevel.DRUNK;
import static com.powple.poc.intoxication.DrunkLevel.SOBER;
import static com.powple.poc.intoxication.DrunkLevel.TIPSY;
import static com.powple.poc.intoxication.DrunkLevel.WASTED;
...
//remove::start[]
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.LOCAL, ids = "com.powple.poc:beer-api-producer")
//remove::end[]
@DirtiesContext
//@org.junit.Ignore
